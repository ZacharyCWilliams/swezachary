...
function codeless_portfolio_overlay(){
    ...
    <?php if( $portfolio_overlay_icon != 'lightbox_link' ): ?>
        ...
        <a class="entry-link <?php echo esc_attr( $classes ) ?>" <?php echo codeless_complex_esc( $target ) ?> <?php echo codeless_complex_esc( $caption ) ?> href="<?php echo esc_url($link) ?>" title="<?php esc_attr( the_title() ) ?>"></a>
    <?php endif; ?>
    </div><!-- Entry Overlay -->
