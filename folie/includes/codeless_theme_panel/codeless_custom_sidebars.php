	...
	class CodelessCustomSidebars {
		...
		public static function addPage() {
			if( function_exists( 'codeless_add_submenu_page' ) )
				codeless_add_submenu_page(
					'codeless-panel',
					esc_html__( 'Custom Sidebars', 'folie' ),
					esc_html__( 'Custom Sidebars', 'folie' ),
					'administrator',
		...
		public static function createPage() {
			...
			<div class="wrap">
				...
				<h2><?php esc_html_e( 'Custom Sidebars', 'folie' ); ?></h2>

				<p><?php esc_html_e( 'In this Options Section you can define Custom Sidebars for pages, categories or a completely custom sidebar to be used on page builder (header or content).', 'folie' ); ?></p>
				...
				<form method="post" action="options.php">
					...
					<table class="form-table">
							...
							<tr valign="top">
								...
								<td>
									<label><?php esc_html_e('Custom Sidebar for pages:', 'folie') ?></label>
							...
							<tr valign="top">
								...
								<td>
									<label><?php esc_html_e('Custom Sidebar for categories:', 'folie') ?></label>
