...
class cl_backpanel
{
	...
	function __construct(){
         ...
         add_action('admin_enqueue_scripts', array($this, 'pages_enqueue'));

    }
    
    public function pages_enqueue($hook) {
       
        if ( 'post.php' != $hook && 'post-new.php' != $hook ) {
            return;
        }
    
        wp_enqueue_style( 'codeless_pages_css', get_template_directory_uri() . '/includes/core/css/codeless_pages.css' );
        wp_enqueue_script( 'codeless_pages_js', get_template_directory_uri() . '/includes/core/js/codeless_pages.js' );
    ...
    static function get_demos(){
        $demos = array(
            ...
            array(
                'id' => 'modern',
                'label' => 'Modern',
                'preview' => 'http://codeless.co/folie/modern',
                'parts' => 1
            ),
            ...
            array(
                ...
                'preview' => 'http://codeless.co/folie/portfolio-dark',
                'parts' => 1
            ),

            array(
                'id' => 'portfolio-product-fullscreen',
                'label' => 'Portfolio Product Fullscreen',
                'preview' => 'http://codeless.co/folie/portfolio-product-fullscreen',
                'parts' => 1
            ),
            ...
            array(
                ...
                'preview' => 'http://codeless.co/folie/portfolio-metro',
                'parts' => 1
            ),

            array(
                'id' => 'photography-masonry',
                'label' => 'Photography Masonry',
                'preview' => 'http://codeless.co/folie/photography-masonry',
                'parts' => 1
            ),

            array(
                'id' => 'portfolio-fullscreen-carousel',
                'label' => 'Portfolio Fullscreen Carousel',
                'preview' => 'http://codeless.co/folie/portfolio-fullscreen-carousel',
                'parts' => 1
            ),
        );
        return $demos;
