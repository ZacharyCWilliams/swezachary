<?php
    ...
    Kirki::add_section( 'cl_styling', array(
    	...
    	Kirki::add_field( 'cl_folie', array(
		    'type' => 'color',
		    'settings' => 'text_links_color',
			'label' => 'Content Link Color',
			'tooltip' => 'The color of the link on a standard page',
			'default' => '#303133',
			'inline_control' => true,
			'choices' => array(
				'alpha' => false,
    	...
    	Kirki::add_field( 'cl_folie', array(
		    'type' => 'color',
		    'settings' => 'text_links_color_hover',
			'label' => 'Content Link Color Hover',
			'tooltip' => 'The color on hover of the link on a standard page',
			'default' => '#303133',
			'inline_control' => true,
			'choices' => array(
				'alpha' => false,
    	...
    	Kirki::add_field( 'cl_folie', array(
		    'type' => 'color',
		    'settings' => 'blog_grid_wrapper_bg',
			'label' => 'Blog Grid Wrapper BG Color',
			...
			'output' => array(
				array(
					'element' => '#blog-entries .grid-style .grid-holder .grid-holder-inner' ,
					'property' => 'background-color'
				),
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Blog Comments Field BG Color', 'folie' ),
			'section'     => 'cl_styling',
			'into_group' => true,
			'inline_control' => true,
			'default'     => '#ffffff',
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Single Blog Extra Sections Title', 'folie' ),
			'section'     => 'cl_styling',
			'into_group' => true,
			'show_subsets' => false,
			'default'     => array(
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Sidebar Search BG Color', 'folie' ),
			'section'     => 'cl_styling',
			'into_group' => true,
			'inline_control' => true,
			'default'     => '#ffffff',
