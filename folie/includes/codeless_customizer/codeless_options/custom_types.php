<?php
    ...
    Kirki::add_panel( 'cl_custom_types', array(
	    ...
	    'tooltip' => __( 'All Custom Types Options', 'folie' ),
	) );
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Used as prefix for portfolio items links', 'folie' ),
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Turn On / Off Portfolio Navigation functionalities', 'folie' ),
			'section'  => 'cl_custom_portfolio',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
