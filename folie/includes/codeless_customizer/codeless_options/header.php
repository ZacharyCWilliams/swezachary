...
Kirki::add_panel('cl_header', array(
	...
	'tooltip' => __('All Header Options', 'folie') ,
));
...
Kirki::add_section('cl_header_general', array(
	...
	'tooltip' => __('General Header Layout, global header options', 'folie') ,
	'panel' => 'cl_header',
	'type' => '',
	'priority' => 160,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Select type of header to use', 'folie') ,
	'section' => 'cl_header_general',
	'type' => 'select',
	'default' => 'top',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Select the position (alignment) of logo', 'folie') ,
	'section' => 'cl_header_general',
	'type' => 'select',
	'default' => 'center',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch On to force the middle column of the main Header Row to be centered.', 'folie') ,
	'section' => 'cl_header_general',
	'type' => 'switch',
	'priority' => 10,
	'default' => 0,
...
Kirki::add_field('cl_folie', array(
	'type'        => 'sortable',
	'settings'    => 'header_columns_responsive_order',
	'label'       => __( 'Order Responsive Header Columns for Main Row', 'folie' ),
	'section'     => 'cl_header_general',
	'default'     => array(
		'left',
		'middle',
	...
	'choices'     => array(
		'left' => esc_attr__( 'Left Column', 'folie' ),
		'middle' => esc_attr__( 'Middle Column', 'folie' ),
		'right' => esc_attr__( 'Right Column', 'folie' )
	),
	'priority'    => 10,
));
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Select font or image logo type', 'folie') ,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Upload here the logo that is placed in top of the page', 'folie') ,
	'section' => 'cl_header_logo',
	'type' => 'image',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Upload logo that will be shown on dark baackground or header', 'folie') ,
	'section' => 'cl_header_logo',
	'type' => 'image',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Define the Height of your logo', 'folie') ,
	'section' => 'cl_header_logo',
	'type' => 'number',
	'priority' => 10,
	'default' => 20,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Upload logo that will be shown only on iPhone', 'folie') ,
	'section' => 'cl_header_logo',
	'into_group' => true,
	'type' => 'image',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Upload logo that will be shown only on iPad', 'folie') ,
	'section' => 'cl_header_logo',
	'into_group' => true,
	'type' => 'image',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Define the Height of your logo in iPad', 'folie') ,
	'section' => 'cl_header_logo',
	'into_group' => true,
	'type' => 'number',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Define the Height of your logo in iPhone', 'folie') ,
	'section' => 'cl_header_logo',
	'into_group' => true,
	'type' => 'number',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch on if you want to apply the style over full menu item or switch off if you want only text to take the style.', 'folie') ,
	'section' => 'cl_header_menu',
	'type' => 'switch',
	'priority' => 10,
	'default' => 1,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => esc_attr__('Except Main Navigation Items', 'folie'),
	'section' => 'cl_header_menu',
	'into_group' => true,
	'default' => array(
		'variant' => '600',
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => esc_attr( 'All other items without Submenu, Except Main Navigation Items.', 'folie' ),
	'section' => 'cl_header_menu',
	'into_group' => true,
	'default' => array(
		'font-size' => '12px',
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Not only border, but add a light shadow that will look awesome on white pages', 'folie') ,
	'section' => 'cl_header_main',
	'type' => 'switch',
	'priority' => 10,
	'default' => 1,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch on to active Top Header Navigation Row, than you can add elements.', 'folie') ,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch on to active Top Header Navigation Row on sticky', 'folie') ,
	'section' => 'cl_header_top_row',
	'type' => 'switch',
	'priority' => 10,
	'default' => 0,
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch on to active custom typography for top navigation', 'folie') ,
	'section' => 'cl_header_top_row',
	'type' => 'switch',
	'default' => 0,
	'choices' => array(
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('Switch on to active Extra Header Navigation Row, than you can add elements.', 'folie') ,
...
Kirki::add_field('cl_folie', array(
	...
	'label' => __('Show on sticky', 'folie') ,
	'tooltip' => __('Switch on to active Extra Header Row Row on sticky', 'folie') ,
	'section' => 'cl_header_extra_row',
	'type' => 'switch',
	'priority' => 10,
	'default' => 0,
...
Kirki::add_section('cl_header_dropdown', array(
	...
	'tooltip' => __('All styles of dropdown, megamenu and mobile', 'folie') ,
	'panel' => 'cl_header',
	'type' => '',
	'priority' => 160,
	'capability' => 'edit_theme_options'
...
Kirki::add_section('cl_header_default', array(
	'title' => __('Default Header Options', 'folie') ,
	'tooltip' => __('Default site header options, you can overwrite in each page or post. This will be default for all archives.', 'folie') ,
	'panel' => 'cl_header',
	'type' => '',
	'priority' => 160,
	'capability' => 'edit_theme_options'
...
Kirki::add_field('cl_folie', array(
	'settings' => 'default_header_desc',
	'section' => 'cl_header_default',
	'type' => 'custom',
	'priority' => 10,
	'default' => __('Default site header options, you can overwrite in each page or post. This will be default for all archives.', 'folie') ,
	'transport' => 'postMessage'
));
Kirki::add_field('cl_folie', array(
	'settings' => 'default_header_color',
	'label' => __('Default Header Color', 'folie') ,
	'tooltip' => __('', 'folie') ,
	'section' => 'cl_header_default',
	'type' => 'select',
	'priority' => 10,
...
Kirki::add_field('cl_folie', array(
	'settings' => 'default_header_transparent',
	'label' => __('Default Header Transparent', 'folie') ,
	'tooltip' => __('', 'folie') ,
	'section' => 'cl_header_default',
	'type' => 'select',
	'priority' => 10,
	...
	'choices' => array(
		'transparent' => esc_attr__('Transparent', 'folie') ,
...
Kirki::add_section('cl_header_sticky', array(
	...
	'tooltip' => __('Make header sticky', 'folie') ,
	'panel' => 'cl_header',
	'type' => '',
	'priority' => 160,
	'capability' => 'edit_theme_options'
...
Kirki::add_field('cl_folie', array(
	...
	'tooltip' => __('By switch this option, your header will be sticky', 'folie') ,
...
Kirki::add_field('cl_folie', array(
	...
	'label' => __('Sticky Mobile', 'folie') ,
	'tooltip' => __('By switch this option, your header will be sticky on mobile', 'folie') ,
	'section' => 'cl_header_sticky',
	'type' => 'switch',
	'priority' => 10,
	'default' => 0,
