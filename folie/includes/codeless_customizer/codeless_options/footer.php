...
Kirki::add_panel( 'cl_footer', array(
	    ...
	    'tooltip' => __( 'Footer Options and Layout', 'folie' ),
	) );


Kirki::add_section('cl_footer_general', array(
	'title' => __('General', 'folie') ,
	'tooltip' => __('General Footer Options', 'folie') ,
	'panel' => 'cl_footer',
	'type' => '',
	'priority' => 160,
	'capability' => 'edit_theme_options'
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Switch On/Off Footer on website', 'folie' ),
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Switch On if you want footer content without container', 'folie' ),
			'section'  => 'cl_footer_general',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Use this option to change layout of footer. You can use the UI on the page too.', 'folie' ),
			'section'  => 'cl_footer_general',
			'type'     => 'select',
			'priority' => 10,
			'default'  => '14_14_14_14',
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Switch to center content of column', 'folie' ),
			'section'  => 'cl_footer_general',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Switch On/Off Copyright on website', 'folie' ),
			'section'  => 'cl_footer_general',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Switch On/Off to activate reveal footer effect', 'folie' ),
			'section'  => 'cl_footer_general',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
...
Kirki::add_section('cl_footer_design', array(
	...
	'tooltip' => __('Main Footer Design Options', 'folie') ,
	'panel' => 'cl_footer',
	'type' => '',
	'priority' => 160,
	'capability' => 'edit_theme_options'
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Main Footer Title Typography', 'folie' ),
			'section'     => 'cl_footer_design',
			'into_group' => true,
			'default'     => array(
				'font-family'    => 'Poppins',
		...
		Kirki::add_field( 'cl_folie', array(
			'settings' => 'custom_content_typography',
			'label'    => __( 'Custom Footer Content Typography', 'folie' ),
			'tooltip' => __( '', 'folie' ),
			'section'  => 'cl_footer_design',
			'type'     => 'switch',
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			'type'        => 'typography',
			'settings'    => 'main_footer_content_typography',
			'label'       => esc_attr__( 'Main Footer Content Typography', 'folie' ),
			'section'     => 'cl_footer_design',
			'into_group' => true,
			'default'     => array(
			...
			'output'      => array(
				array(
					'element' => codeless_dynamic_css_register_tags( 'main_footer_content_typography' )
				),

			),
			'required'    => array(
				array(
					'setting'  => 'custom_content_typography',
					'operator' => '==',
					'value'    => true,
					'transport' => 'postMessage'
				),
		...
		Kirki::add_section('cl_footer_copyright', array(
			...
			'tooltip' => __('Copyright Design Options', 'folie') ,
			'panel' => 'cl_footer',
			'type' => '',
			'priority' => 160,
			'capability' => 'edit_theme_options'
