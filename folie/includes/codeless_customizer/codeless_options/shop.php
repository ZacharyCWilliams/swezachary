...
Kirki::add_section( 'cl_shop', array(
	    ...
	    'type' => '',
	    'title'       => __( 'Shop', 'folie' ),
	    'tooltip' => __( 'All Shop Options', 'folie' ),
	) );
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Select number of items to display per Row on SHOP Page', 'folie' ),
			'section'  => 'cl_shop',
			'type'     => 'select',
			'priority' => 10,
			'default'  => '3',
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Select shop Product Categories page layout.', 'folie' ),
			'section'  => 'cl_shop',
			'type'     => 'select',
			'priority' => 10,
			'default'  => 'fullwidth',
