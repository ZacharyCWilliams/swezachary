...
Kirki::add_section( 'cl_blog', array(
	    ...
	    'type' => '',
	    'title'       => __( 'Blog', 'folie' ),
	    'tooltip' => __( 'All Blog Styles and options', 'folie' ),
	) );
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Enable if you want to make this style boxed with small shadow around', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Overwrite the default all pages layout option, set a custom layout for blog', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'priority' => 10,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Set a custom width in percentage for your blog', 'folie' ),
			'default' => 100,
			'choices'     => array(
				'min'  => '20',
				'max'  => '100',
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Archives & Categories Layout', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'priority' => 10,
			'default'  => 'right_sidebar',
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'If enabled you will see only a small part of content. If disabled all post will show', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => esc_html__( 'Blog Share Buttons', 'folie' ),
			'tooltip' => esc_html__( 'Select Social share buttons that you want to use on blog page', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'multiple' => 6,
			'priority' => 10,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Select the style of overlay of blog image on hover', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'priority' => 10,
			'default'  => 'color',
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Disable if you dont want that image linked with post', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Single Blog Layout', 'folie' ),
			'tooltip' => __( 'Change the layout of blog posts, you can add custom sidebar for posts also.', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'priority' => 10,
			'default'  => 'right_sidebar',
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Single Blog Style', 'folie' ),
			'tooltip' => __( 'Change the style of blog posts, you can add custom style for each post.', 'folie' ),
			'section'  => 'cl_blog',
			'type'     => 'select',
			'priority' => 10,
			'default'  => 'modern',
		...
		Kirki::add_field( 'cl_folie', array(
		    'type' => 'select',
		    'settings' => 'single_blog_align',
			'label' => __( 'Single Blog Align', 'folie' ),
			'tooltip' => __( 'Single Blog Align', 'folie' ),
			'default' => 'left',
			'section'  => 'cl_blog',
			'choices'     => array(
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'label' => __( 'Single Blog Width', 'folie' ),
			'default' => 1080,
			'choices'     => array(
				'min'  => '400',
				'max'  => '1600',
			...
			'output' => array(
				array(
					'element' => '.single-post .cl-layout-fullwidth .inner-content.container',
					'units' => 'px',
					'property' => 'width',
					'media_query' => '@media (min-width: 992px)'
				)
    	...
    	Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Single Blog Title Margin Top', 'folie' ),
			'section'     => 'cl_blog',
			'into_group' => true,
			'default'     => '0',
			'priority'    => 10,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'       => esc_attr__( 'Single Blog Title Margin Bottom', 'folie' ),
			'section'     => 'cl_blog',
			'into_group' => true,
			'default'     => '40',
			'priority'    => 10,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Leave 0 to remove autoplay', 'folie' ),
			'default' => 0,
			'choices'     => array(
				'min'  => '0',
				'max'  => '5000',
