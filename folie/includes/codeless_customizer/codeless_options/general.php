<?php
	...
	Kirki::add_panel( 'cl_general', array(
	    ...
	    'tooltip' => __( 'All General Options of theme', 'folie' ),
	) );
	...
	Kirki::add_section( 'cl_general_options', array(
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Turn On / Off Responsive functionalities', 'folie' ),
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __('Active smoothscroll over pages to make scrolling more fluid to create better user experience', 'folie' ),
			'section'  => 'cl_general_options',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'tooltip' => __( 'Upload favion for website', 'folie' ),
			'section'  => 'cl_general_options',
			'type'     => 'image',
			'default' => '',
		) );
	...
	Kirki::add_section( 'cl_general_lightbox', array(
	    'title'          => __( 'Lightbox', 'folie' ),
	    'description'    => __( 'Lightbox Options', 'folie' ),
	    'panel'          => 'cl_general',
	    'priority'       => 160,
	    'type'			 => '',
	    'capability'     => 'edit_theme_options'
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Mousewheel', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Toolbar', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Arrows', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Slideshow', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 0,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Fullscreen', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Thumbnail', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
		...
		Kirki::add_field( 'cl_folie', array(
			...
			'label'    => __( 'Lightbox Context Menu (Right click on image)', 'folie' ),
			'section'  => 'cl_general_lightbox',
			'type'     => 'switch',
			'priority' => 10,
			'default'  => 1,
