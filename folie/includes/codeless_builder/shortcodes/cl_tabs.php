...
<div id="<?php echo esc_attr( $tabs_id ) ?>" class="cl-element cl_tabs <?php echo esc_attr( $this->generateClasses('.cl_tabs') ) ?>" <?php $this->generateStyle('.cl_tabs', true) ?>>

	<?php echo codeless_complex_esc( $tabs_nav ) ?>
	<!-- Tab panes -->
