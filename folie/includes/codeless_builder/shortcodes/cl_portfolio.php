...
$cl_from_element['portfolio_preset_masonry'] = $preset_masonry;
$cl_from_element['portfolio_animation_delay'] = $portfolio_animation_delay;
$cl_from_element['portfolio_carousel'] = $carousel;
...
<?php
    ...
    while ( $the_query->have_posts() ) : $the_query->the_post();
        ...
        if( $portfolio_animation == 'interchange_left_right' ){
            if( $i % 2 == 1 )
                $cl_from_element['portfolio_animation'] = 'reveal-left';
            else
                $cl_from_element['portfolio_animation'] = 'reveal-right';
        }
