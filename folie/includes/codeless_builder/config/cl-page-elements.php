					...
					'general_tab_start' => array(
						...
						'row_layout_start' => array(
							...
							'content_pos' => array(
								'type'     => 'inline_select',
								'priority' => 10,
								'label'       => esc_attr__( 'Content Position (Fullheight)', 'folie' ),
								'tooltip' => esc_attr__( 'Change position of columns and elements into the fullheight Row. Works on Fullheight', 'folie' ),
								'default'     => 'middle',
								'choices' => array(
									'middle' => 'Middle',
									'top' => 'Top',
							...
							'custom_width' => array(
								...
								'tooltip' => esc_attr__( 'Is applied only for media screen (min-width: 1200px)', 'folie' ),
						...
						'row_info_start' => array(
							...
							'row_id' => array(
								...
								'tooltip' => esc_attr__( 'This is useful when you want to add unique identifier to row.', 'folie' ),
								'default'     => '',
							),
							...
							'extra_class' => array(
								...
								'tooltip' => esc_attr__( 'Add extra class identifiers to this row, that can be used for various custom styles.', 'folie' ),
								'default'     => '',
							),
							...
							'anchor_label' => array(
								...
								'tooltip' => esc_attr__( 'Used on Vertical Codeless Slider', 'folie' ),
								'default'     => '',
								'selector' => '.cl-row',
								'htmldata' => 'anchor'
							),
					...
					'design_tab_start' => array(
						...
						'background_image_group' => array(
							...
							'background_size' => array(
								'type'     => 'inline_select',
								'priority' => 10,
								'label'       => esc_attr__( 'Background Size', 'folie' ),
					...
					'responsive_tab_start' => array(
						...
						'tabid' => 'responsive'
							...
							'device_visibility' => array(
								...
								'default'     => '',
								'choices' => array(
									'hidden-xs' => esc_attr__( 'Hide on Phones (smaller-than-768px)', 'folie' ),
									'hidden-sm' => esc_attr__('Hide on Tables (larger-then-768px)', 'folie' ),
									'hidden-md' => esc_attr__('Hide on Medium Desktops (larger-then-992px) ', 'folie' ),
									'hidden-lg' => esc_attr__('Hide on Large Desktops (larger-then1200px)', 'folie' ),
								),
								'selector' => '.cl-row',
								'selectClass' => '',
								'group_vc' => 'Responsive',
							...
							'col_responsive' => array(
								'type'        => 'inline_select',
								'label'       => esc_html__( 'Responsive Columns', 'folie' ),
								'tooltip' => 'This option will change the width of columns on tablets sizes from (768px to 992px). Important option to build responsive perfect layouts.',
								'default'     => 'none',
								'priority'    => 10,
								'choices'     => array(
							...
							'css_style_991_row_bool' => array(
								'type'        => 'switch',
								'label'       => esc_html__( 'Custom Box Design on max-width:991px (Tablet & Mobile)', 'folie' ),
								'tooltip'       => esc_html__( 'Add custom box design (padding etc) on screen sizes max-width:991px', 'folie' ),
								'default'     => 0,
								'priority'    => 10,
								'choices'     => array(
									'on'  => esc_attr__( 'On', 'folie' ),
							...
							'css_style_767_row_bool' => array(
								'type'        => 'switch',
								'label'       => esc_html__( 'Custom Box Design on max-width:767px (Only Mobile)', 'folie' ),
								'tooltip'       => esc_html__( 'Add custom box design (padding etc) on screen sizes max-width:767px', 'folie' ),
								'default'     => 0,
								'priority'    => 10,
								'choices'     => array(
									'on'  => esc_attr__( 'On', 'folie' ),
	...
	cl_builder_map(array(
		...
		'fields' => array(
			'inner_columns_gap' => array(
						'type'     => 'slider',
						'priority' => 10,
						'label'       => esc_attr__( 'Inner Columns Gap', 'folie' ),
						'default'     => '15',
						'choices'     => array(
							'min'  => '0',
							'max'  => '35',
	...
	cl_builder_map(array(
		...
		'fields' => array(
			'width' => array(
				...
				'tooltip' => esc_attr__( 'This will be the label for your link', 'folie' ),
				'default'     => '1/1',
				'show' => false,
				'choices'     => array(
					'1/12' => '1 Column',
			...
			'general_tab_start' => array(
				...
				'column_info_start' => array(
					...
					'horizontal_align' => array(
						...
						'tooltip' => esc_attr__( 'Horizontal Alignment of elements into this column(container)', 'folie' ),
						'default'     => 'left',
						'choices' => array(
							'left' => 'Left',
							'middle' => 'Middle',
					...
					'vertical_align' => array(
						...
						'tooltip' => esc_attr__( 'Vertical Alignment of elements into this column(container)', 'folie' ),
						'default'     => 'top',
						'choices' => array(
							'top' => 'Top',
							'middle' => 'Middle',
					...
					'col_id' => array(
						...
						'tooltip' => esc_attr__( 'This is useful when you want to add unique identifier to columns.', 'folie' ),
						'default'     => '',
					),
					...
					'extra_class' => array(
						...
						'priority' => 10,
						'label'       => esc_attr__( 'Extra Class', 'folie' ),
						'tooltip' => esc_attr__( 'Add extra class identifiers to this column, that can be used for various custom styles.', 'folie' ),
						'default'     => '',
					),
					...
					'target' => array(
						...
						'type' => 'inline_select',
						'priority' => 10,
						'label' => esc_attr__('Specify where to open the custom link ', 'folie'),
						'default' => '_self',
						'choices' => array(
		...
		'fields' => array(
			...
			'responsive_tab_start' => array(
				...
				'css_style_991_colinner_bool' => array(
						'type'        => 'switch',
						'label'       => esc_html__( 'Custom Box Design on max-width:991px (Table & Mobile)', 'folie' ),
						'tooltip'       => esc_html__( 'Add custom box design (padding etc) on screen sizes max-width:991px', 'folie' ),
						'default'     => 0,
						'priority'    => 10,
						'choices'     => array(
			...
			'responsive_start' => array(
				...
				'custom_responsive_992_bool' => array(
					...
					'custom_responsive_992_size' => array(
						...
						'tooltip' => esc_attr__( 'Add a custom size for this heading for screens smaller than 992px', 'folie' ),
						'default'     => '24px',
						'selector' => '.cl-text',
						'css_property' => 'font-size',
					...
					'custom_responsive_992_line_height' => array(
						...
						'tooltip' => esc_attr__( 'Add a custom line height for this heading for screens smaller than 992px', 'folie' ),
						'default'     => '30px',
						'selector' => '.cl-text',
						'css_property' => 'line-height',
						'media_query' => '(max-width: 992px)',
				...
				'custom_responsive_768_bool' => array(
					...
					'custom_responsive_768_size' => array(
						...
						'tooltip' => esc_attr__( 'Add a custom size for this heading for screens smaller than 768px', 'folie' ),
						'default'     => '18px',
						'selector' => '.cl-text',
						'css_property' => 'font-size',
					...
					'custom_responsive_768_line_height' => array(
						...
						'tooltip' => esc_attr__( 'Add a custom line height for this heading for screens smaller than 768px', 'folie' ),
						'default'     => '26px',
						'selector' => '.cl-text',
						'css_property' => 'line-height',
						'media_query' => '(max-width: 768px)',
	...
	cl_builder_map(array(
		...
		'fields' => array(
			'content' => array(
				...
				'holder' => 'h2',
				'group_vc' => esc_attr__('General', 'folie')
			),
			...
			'typography' => array(
						...
						'group_vc' => esc_attr__('Typography', 'folie')
					),
			...
			'responsive_start' => array(
				...
				'custom_responsive_992_bool_ch' => array(
						...
						array(
							...
							'group_vc' => esc_attr__('Responsive', 'folie')
			...
			'responsive_end' => array(
				...
				'animation_start' => array(
					...
					'animation' => array(
						...
						'selector' => '.cl-custom-heading',
						'group_vc' => esc_attr__('Animation', 'folie')
					),
			...
			'box_start' => array(
				...
				'css_style' => array(
					...
					'css_property' => '',
					'default' => array('margin-top' => '35px'),
					'group_vc' => esc_attr__('Design', 'folie')
				),
...
cl_builder_map(array(
	...
	'fields' => array(
		'height' => array(
			...
			'tooltip' => esc_attr__( 'Set the divider height', 'folie' )
 ...
 cl_builder_map(array(
		...
		'settings'    => 'cl_media',
		'is_container' => false,
		'css_dependency' => array( CODELESS_BASE_URL.'css/ilightbox/'.codeless_get_mod('lightbox_skin', 'dark').'-skin/skin.css', CODELESS_BASE_URL.'css/ilightbox/css/ilightbox.css'),
		'marginPositions' => array('top'),
		'fields' => array(
				'media_type' => array(
					'type'     => 'inline_select',
				...
				'video_mov' => array(
					...
					'tooltip' => esc_attr__( 'Add this video if you want to use it for live photo', 'folie' ),
					'default'     => '',
					'cl_required'    => array(
						array(
							'setting'  => 'media_type',
				...
				'lightbox' => array(
					...
					'tooltip' => esc_attr__( 'Show lightbox icon on image hover', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'lazyload' => array(
					...
					'tooltip' => esc_attr__( 'Image will be loaded only when it\'s on viewport', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'video_start' => array(
					...
					'height' => array(
						...
						'tooltip' => esc_attr__( 'Use this only for embed links and for video with image placeholder.', 'folie' ),
						'default'     => '400',
						'choices'     => array(
							'min'  => '0',
							'max'  => '1000',
 ...
 cl_builder_map(array(
		...
		'fields' => array(
			...
			'carousel_nav' => array(
					...
					'tooltip' => esc_attr__( 'Switch On if you want carousel navigation', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'carousel_dots' => array(
					...
					'tooltip' => esc_attr__( 'Switch On if you want carousel dots ( pagination )', 'folie' ),
					'default'     => 1,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
		...
		'general_tab_start' => array(
			...
			'options_start' => array(
				...
				'layout_type' => array(
					...
					'tooltip' => esc_attr__( 'Select layout type of service element', 'folie' ),
					'default'     => 'media_aside',
					'choices' => array(
				...
				'layout_align' => array(
					...
					'tooltip' => esc_attr__( 'Select the align of content and layout of service element', 'folie' ),
					'default'     => 'align_left',
					'choices' => array(
				...
				'wrapper' => array(
					...
					'tooltip' => esc_attr__( 'Select the type of wrapper around Icon if you want one', 'folie' ),
		...
		'design_tab_begin' => array(
			...
			'icon_start' => array(
				...
				'icon_font_size' => array(
					...
					'tooltip' => esc_attr__( 'Change Icon size by moving the slider', 'folie' ),
					'default'     => '36',
					'choices'     => array(
						'min'  => '14',
						'max'  => '120',
				...
				'wrapper_size' => array(
					...
					'tooltip' => esc_attr__( 'Change Wrapper size by moving the slider. Can be used for SVG size too.', 'folie' ),
					'default'     => '72',
					'choices'     => array(
						'min'  => '30',
						'max'  => '240',
				...
				'wrapper_distance' => array(
					...
					'tooltip' => esc_attr__( 'Icon and Wrapper distance from content', 'folie' ),
					'default'     => '20',
					'choices'     => array(
						'min'  => '0',
						'max'  => '140',
				...
				'title_distance_top' => array(
					...
					'tooltip' => esc_attr__( 'Drag to change the distance of the title from top of element', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '30',
				...
				'title_content_distance' => array(
					...
					'tooltip' => esc_attr__( 'Drag to change the distance of the content from Title', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '140',
				...
				'title_subtitle_distance' => array(
					...
					'tooltip' => esc_attr__( 'Drag to change the distance of the title from subtitle', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '140',
			...
			'typography_start' => array(
				...
				'title_typography' => array(
					...
					'group_vc' => esc_attr('Typography', 'folie')
				),	
			...
			'animation_start' => array(
				...
				'animation' => array(
					...
					'selector' => '.cl_service',
					'group_vc' => esc_attr('Animation', 'folie')
				),
 ...
 cl_builder_map(array(
	...
	'css_dependency' => array( CODELESS_BASE_URL.'css/codeless-portfolio.css',CODELESS_BASE_URL.'css/ilightbox/'.codeless_get_mod('lightbox_skin', 'dark').'-skin/skin.css', CODELESS_BASE_URL.'css/ilightbox/css/ilightbox.css', CODELESS_BASE_URL.'css/owl.carousel.min.css', CODELESS_BASE_URL.'css/codeless-image-filters.css'),
	'marginPositions' => array('top'),
	'is_container' => false,
	'fields' => array(
		...
		'general_tab_start' => array(
			...
			'options_start' => array(
				...
				'preset_masonry' => array(
					'type'     => 'inline_select',
					'priority' => 10,
					'label'       => esc_attr__( 'Preset Masonry', 'folie' ),
					'default'     => 'none',
					'choices' => array(
						'none' => 'Set all items layout individually, from portfolio item options',
						'preset1' => 'Preset1'
					),
					'reloadTemplate' => true,
					'cl_required'    => array(
				...
				'style' => array(
					...
					'choices' => array(
						...
						'media_content' => 'Media with Content'
					),
					'selector' => '#portfolio-entries',
				...
				'portfolio_justify_maxheight' => array(
					'type'     => 'slider',
					'priority' => 10,
					'label'       => esc_attr__( 'Justify Max Height', 'folie' ),
					'description'       => esc_attr__( 'Leave 0, for infinite max-height', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '1100',
				...
				'portfolio_justify_lastrow' => array(
					'type'     => 'inline_select',
					'priority' => 10,
					'label'       => esc_attr__( 'Justify LastRow', 'folie' ),
					'default'     => 'nojustify',
					'choices'     => array(
				...
				'portfolio_fullheight' => array(
					'type'     => 'switch',
					'priority' => 10,
					'label'       => esc_attr__( 'Portfolio Fullheight', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
			...
			'carousel_start' => array(
				...
				'carousel' => array(
					...
					'tooltip' => esc_attr__( 'Switch On if you want carousel', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
			...
			'extra_style' => array(
				...
				'image_filter' => array(
					...
					'tooltip' => esc_attr__( 'Applied on portfolio images', 'folie' ),
					'default'     => 'normal',
					'choices' => array(
						'normal' => 'normal',
						'darken' => 'darken',
				...
				'boxed' => array(
					...
					'tooltip' => esc_attr__( 'Switch On if you want to add a boxed shadow. Works only on Classic and Classic with Excerpt', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'portfolio_animation_delay' => array(
					'type'     => 'inline_select',
					'priority' => 10,
					'label'       => esc_attr__( 'Animation Delay', 'folie' ),
			...
			'query_start' => array(
				...
				'categories' => array(
					...
					'default'     => '',
					'choices' => codeless_get_terms( 'portfolio_entries', true ),
					'reloadTemplate' => true,
				...
				'posts_per_page' => array(
					...
					'tooltip' => __( 'Maximal number of items that will show in one portfolio page', 'folie' ),
					'default'  => 12,
					'reloadTemplate' => true
				),
			...
			'overlay_layout' => array(
				...
				'portfolio_overlay' => array(
					...
					'choices'     => array(
						...
						'antigrayscale'  => esc_attr__( 'From Grayscale to normal', 'folie' ),
				...
				'portfolio_overlay_layout' => array(
					...
					'priority' => 10,
					'label'       => esc_attr__( 'Layout', 'folie' ),
					'tooltip' => esc_attr__( 'Position of content into the overlay ( icons, title, tags )', 'folie' ),
					'default'     => 'center',
				...
				'portfolio_overlay_distance' => array(
					...
					'tooltip' => esc_attr__( 'Distance between portfolio overlay and photo corners', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '100',
 ...
 cl_builder_map(array(
	...
	'fields' => array(
		'slider_height' => array(
					...
					'tooltip' => esc_attr__( 'This is used as slider height. All slides inherit this value', 'folie' ),
					'default'     => '400',
					'choices'     => array(
						'min'  => '200',
						'max'  => '2000',
		...
		'fullheight_slider_responsive' => array(
					'type'        => 'switch',
		...
		'effect' => array(
					...
					'tooltip' => esc_attr__( 'Need reload to function properly. Test it in website frontpage or make a reload here.', 'folie' ),
					'default'     => 'fade',
					'choices' => array(
						'fade' => 'Fade',
						'slide' => 'Slide',
		...
		'responsive_plain_slider' => array(
					'type'        => 'switch',
					'label'       => __( 'Slider as Plain in responsive (Vertical)', 'folie' ),
		...
		'autoplay' => array(
					...
					'tooltip' => esc_attr__( 'Leave 0 if you dont want an autoplay slider', 'folie' ),
					'default'     => '6500',
					'selector' => '.cl_slider',
					'htmldata' => 'clautoplay'
				),
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'add_scroll_svg' => array(
					...
					'tooltip' => __( 'By activate this a new SVG Mouse Scroll indication will show on this slide.', 'folie' ),
					'default'     => 0,
					'priority'    => 10,
					'choices'     => array(
						'on'  => esc_attr__( 'On', 'folie' ),
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'carousel_start' => array(
				...
				'testimonial_autoplay' => array(
					'type'     => 'switch',
					'priority' => 10,
					'label'       => esc_attr__( 'Autoplay', 'folie' ),
					'tooltip' => esc_attr__( 'Set carousel to autoplay', 'folie' ),
					'default'     => 0,
					'choices' => array(
						1 => 'On',
						0 => 'Off'
			...
			'query_start' => array(
				...
				'categories' => array(
					...
					'default'     => '',
					'choices' => codeless_get_terms( 'testimonial_entries', true ),
					'reloadTemplate' => true,
					'replace_type_vc' => 'dropdown_multi'
				),
				...
				'posts_per_page' => array(
					'type' => 'text',
					'label'    => __( 'Items to show', 'folie' ),
					'tooltip' => __( 'Maximal number of items that will show', 'folie' ),
					'default'  => 12,
					'reloadTemplate' => true
				),
	...
	cl_builder_map(array(
		...
		'is_container' => false,
		'marginPositions' => array('top'),
		'css_dependency' => array( CODELESS_BASE_URL.'css/ilightbox/'.codeless_get_mod('lightbox_skin', 'dark').'-skin/skin.css',CODELESS_BASE_URL.'css/ilightbox/css/ilightbox.css', CODELESS_BASE_URL.'css/owl.carousel.min.css', CODELESS_BASE_URL.'css/codeless-image-filters.css'),
		'fields' => array(
			'general_group_start' => array(
				...
				'blog_style' => array(
					...
					'tooltip' => __( 'Select one of the blog styles that you want to use as a default template', 'folie' ),
					'default'     => 'grid',
					'choices'     => array(
						'default'  => esc_attr__( 'Default', 'folie' ),
				...
				'blog_news' => array(
					...
					'tooltip' => __( 'Select one of the blog news grid layouts.', 'folie' ),
					'default'     => 'grid_1',
					'choices' => array(
						'grid_1' => 'Layout 1',
						'grid_2' => 'Layout 2',
				...
				'blog_simple' => array(
					...
					'tooltip' => esc_attr__( 'By Switch On this, a custom simplified style will be supplied. Blog Element will look awesome!', 'folie' ),
					'default'     => 1,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'blog_simple_font' => array(
					...
					'tooltip' => esc_attr__( 'By Switch On this, a custom font size (16px) will apply for Blog Title. This option works only on blog simplified', 'folie' ),
					'default'     => 1,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'blog_remove_meta' => array(
					...
					'tooltip' => esc_attr__( 'By switch ON this option, will be removed all meta of blogs (author, date, categories). If you want you can switch this option OFF and manage them directly from General Blog Section', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
				...
				'image_filter' => array(
					...
					'priority' => 10,
					'label'       => esc_attr__( 'Images Filter', 'folie' ),
					'tooltip' => esc_attr__( 'Applied on blog images', 'folie' ),
					'default'     => 'normal',
					'choices' => array(
						'normal' => 'normal',
						'darken' => 'darken',
			...
			'query_start' => array(
				...
				'categories' => array(
					...
					'default'     => '',
					'choices' => codeless_get_terms( 'post', true ),
					'reloadTemplate' => true,
					'replace_type_vc' => 'dropdown_multi'
				),
			...
			'general_end' => array(
			 ...
			 'query_start' => array(
				...
				'categories' => array(
					...
					'default'     => '',
					'choices' => codeless_get_terms( 'staff_entries', true ),
					'reloadTemplate' => true,
					'cl_required'    => array(
						array(
							'setting'  => 'is_single',
		...
		cl_builder_map(array(
			...
			'fields' => array(
				...
				'shortcode' => array(
						...
						'tooltip' => esc_attr__( 'Select one of Woocommerce elements that you want to add', 'folie' ),
	 ...
	 cl_builder_map(array(
		...
		'fields' => array(
			...
			'custom_767' => array(
					...
					'tooltip' => esc_attr__( 'Is applied only for media screen (max-width:767px)', 'folie' ),
					'default'     => '60',
			...
			'custom_1024' => array(
					...
					'tooltip' => esc_attr__( 'Is applied only for media screen (max-width:1024px)', 'folie' ),
					'default'     => '60',
...
4. A card appears at the bottom of the screen with more info.<br />",
			...
			'style' => array(
					...
					'priority' => 10,
					'label'       => esc_attr__( 'Style', 'folie' ),
					'tooltip' => esc_attr__( 'Map Style, leave normal for the default style.', 'folie' ),
					'default'     => 'normal',
					'choices' => array(
						'normal' => 'Normal',
	 ...
	 cl_builder_map(array(
		...
		'fields' => array(
			...
			'accordion' => array(
					...
					'tooltip' => esc_attr__( 'Make this togggles element function as a accordion', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'is_active' => array(
					...
					'tooltip' => esc_attr__( 'Make active this toggle by default by switch this option ON', 'folie' ),
					'default'     => 0,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'tab_id' => array(
				...
				'tooltip' => esc_attr__( 'Use an unique ID', 'folie' ),
				'default'     => 'tab',
			),
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'distance' => array(
					...
					'tooltip' => esc_attr__( 'Distance between list items in pixel', 'folie' ),
					'default'     => '0',
					'choices'     => array(
						'min'  => '0',
						'max'  => '20',
	...
	cl_builder_map(array(
		...
		'fields' => array(
			...
			'custom_icon' => array(
					...
					'tooltip' => esc_attr__( 'Switch to add a custom icon to list items', 'folie' ),
					'default'     => 1,
					'choices' => array(
						'on' => 'On',
						'off' => 'Off'
...
cl_builder_map(array(
		...
		'type'        => 'clelement',
		'label'       => esc_attr__( 'Widget Sidebar', 'folie' ),
		'section'     => 'cl_codeless_page_builder',
		//'priority'    => 10,
		'icon'		  => 'icon-arrows-expand-vertical1',
		'transport'   => 'postMessage',
		...
		'fields' => array(
			'sidebar' => array(
					'type'     => 'inline_select',
					'priority' => 10,
					'label'       => esc_attr__( 'Sidebar', 'folie' ),
					'default'     => 'default',
