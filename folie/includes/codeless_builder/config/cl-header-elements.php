			...
			'fields'	  => array(
				...
				'hamburger_start' => array(
					...
					'hamburger' => array(
						...
						'tooltip' => 'Switch On to make this menu appear as Hamburger menu. Select one of styles below.',
						'default'     => 0,
						'priority'    => 10,
						'choices'     => array(
							'on'  => esc_attr__( 'On', 'folie' ),
			...
			'fields'	  => array(
						...
						'shop_group' => array(
							...
							'cart_button' => array(
								...
								'tooltip' => 'Show Cart if WooCommerce installed',
								'default'     => 0,
								'priority'    => 10,
								'choices'     => array(
									'on'  => esc_attr__( 'On', 'folie' ),
		...
		cl_builder_map(array(
			...
			'fields'	  => array(
					...
					'icon_color' => array(
							'type' => 'color',
							'label' => 'Icon Color',
							'default' => codeless_get_mod( 'primary_color', '#1fb4cc' ),
							'selector' => '.cl-icon-text i',
							'css_property' => 'color',
							'alpha' => true,
					),
		...
		cl_builder_map(array(
			...
			'fields' => array(
				...
				'hide_responsive' => array(
								...
								'tooltip' => 'Switch On to hide from responsive Header',
								'default'     => 0,
								'priority'    => 10,
								'choices'     => array(
									'on'  => esc_attr__( 'On', 'folie' ),
		...
		cl_builder_map(array(
			...
			'fields'	  => array(
					...
					'widget_sidebar' => array(
							...
							'tooltip' => esc_attr__( 'Select the widgetized area that you want to add', 'folie' ),
							'default'     => '',
