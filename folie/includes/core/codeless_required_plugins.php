...
function codeless_required_plugins() {
  ...
  $plugins = array(
    ...
    array(
      'name' => 'Envato Market',
      'slug' => 'envato-market',
      'source' => 'https://codeless.co/folie/included-plugins/envato-market.zip',
      'required' => true,
      'version' => '2.0.1',
    ...
    array(
        ...
        'source' => 'https://codeless.co/folie/included-plugins/codeless-builder.zip',
        'required' => true,
        'version' => '2.2.2',
        'force_activation' => false,
        'force_deactivation' => false,
    ...
    array(
        ...
        'slug' => 'js_composer',
        'source' => 'https://codeless.co/folie/included-plugins/js_composer.zip',
        'required' => false,
        'version' => '6.0.4',
        'force_activation' => false,
