...
{	
...

	{
		...
		{	
			...
			$check = array('megamenu', 'widgetized', 'megamenu_bg', 'layout', 'bg_type', 'column_hide' );
	...
	class custom_walker extends Walker {
		...
		function end_lvl(&$output, $depth = 0, $args= array()) {
...

			{
...

				{
					...
					$output = str_replace("{replace_one}", "<div class='codeless_custom_menu_mega_menu bg_type-".$this->bg_type." layout-".$this->mega_menu_layout." codeless_mega".$this->max_columns."'>", $output);
		...
		function start_el(&$output, $item, $depth = 0, $args = array(),  $current_object_id = 0) {
			...
			{	
				...
				$this->mega_menu_layout = get_post_meta( $item->ID, '_menu-item-custom_codeless-layout', true);
				...
				if( empty($this->mega_menu_layout) )
					$this->mega_menu_layout = 'boxed';
...

			{
				...
				if( $column_hide != '' ){
					...
					$extra_html = '<img src="'.$this->background_image.'" alt="'.esc_attr__('Column BG', 'folie').'" />';
...
class codeless_custom_menu_backend extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
                ...
                if ( ! empty( $item->_invalid ) ) {
                        ...
                        $title = sprintf( esc_html__( '%s (Invalid)', 'folie' ), $item->title );
                } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
                        $classes[] = 'pending';
                        /* translators: %s: title of menu item in draft status */
                        $title = sprintf( esc_html__('%s (Pending)', 'folie'), $item->title );
                }
                ...
                <li id="menu-item-<?php echo esc_attr( $item_id ); ?>" class="<?php echo esc_attr( $itemValue ); echo implode(' ', $classes ); ?>">
                        <div class="menu-item-bar">
                                <div class="menu-item-handle">
                                        <span class="item-title"><span class="menu-item-title"><?php echo esc_html( $title ); ?></span> <span class="is-submenu" <?php echo codeless_complex_esc( $submenu_text ); ?>><?php esc_html_e( 'sub item', 'folie' ); ?></span></span>
                                        <span class="item-controls">
                                                ...
                                                <span class="item-order hide-if-js">
                                                        ...
                                                        ?>" class="item-move-up" aria-label="<?php esc_attr_e( 'Move up', 'folie' ) ?>">&#8593;</a>
                                                        |
                                                        <a href="<?php
                                                                echo wp_nonce_url(
                                                                        add_query_arg(
                                                        ...
                                                        ?>" class="item-move-down" aria-label="<?php esc_attr_e( 'Move down', 'folie' ) ?>">&#8595;</a>
                                                </span>
                                                <a class="item-edit" id="edit-<?php echo esc_attr( $item_id ); ?>" href="<?php
                                                        echo ( isset( $_GET['edit-menu-item'] ) && $item_id == $_GET['edit-menu-item'] ) ? admin_url( 'nav-menus.php' ) : add_query_arg( 'edit-menu-item', $item_id, remove_query_arg( $removed_args, admin_url( 'nav-menus.php#menu-item-settings-' . $item_id ) ) );
                                                ?>" aria-label="<?php esc_attr_e( 'Edit menu item', 'folie' ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Edit', 'folie' ); ?></span></a>
                                        </span>
                                </div>
                        </div>
                        ...
                        <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo esc_attr( $item_id ); ?>">
                                ...
                                <p class="description description-wide">
                                        <label for="edit-menu-item-title-<?php echo esc_attr( $item_id ); ?>">
                                                <?php esc_html_e( 'Navigation Label', 'folie' ); ?><br />
                                ...
                                <p class="field-link-target description">
                                        <label for="edit-menu-item-target-<?php echo esc_attr( $item_id ); ?>">
                                                ...
                                                <?php esc_html_e( 'Open link in a new tab', 'folie' ); ?>
                                        </label>
                                </p>
                                ...
                                <p class="field-description description description-wide">
                                        <label for="edit-menu-item-description-<?php echo esc_attr( $item_id ); ?>">
                                                ...
                                                <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'folie'); ?></span>
                                        </label>
                                </p>
                                ...
                                <div class='codeless_custom_menu_options'>
                                                ...
                                                $title = 'Change layout of this megamenu item';

                                                $key = "menu-item-custom_codeless-layout";
                                                ...
                                                <p class="description description-wide codeless_background_image codeless_custom_mega_menu codeless_custom_mega_menu_d1">
                                                        ...
                                                        <label for="edit-<?php echo esc_attr( $key.'-'.$item_id ); ?>">
                                                                ...
                                                                <select id="edit-<?php echo esc_attr( $key.'-'.$item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[". $item_id ."]" );?>">
                                                                        ...
                                                                        <option value="boxed" <?php if( $value == 'boxed' ): echo 'selected="selected"'; endif; ?>><?php esc_attr_e('Boxed', 'folie') ?></option>
                                                                        <option value="fullwidth" <?php if( $value == 'fullwidth' ): echo 'selected="selected"'; endif; ?>><?php esc_attr_e('Fullwidth', 'folie') ?></option>
                                                                </select>
                                                ...
                                                <p class="description description-wide codeless_background_image codeless_custom_mega_menu codeless_custom_mega_menu_d1">
                                                        ...
                                                        <label for="edit-<?php echo esc_attr( $key.'-'.$item_id ); ?>">
                                                                ...
                                                                <select id="edit-<?php echo esc_attr( $key.'-'.$item_id ); ?>" class=" <?php echo esc_attr( $key ); ?>" name="<?php echo esc_attr( $key . "[". $item_id ."]" );?>">
                                                                        ...
                                                                        <option value="background" <?php if( $value == 'background' ): echo 'selected="selected"'; endif; ?>><?php esc_attr_e('Megamenu Background', 'folie') ?></option>
                                                                        <option value="column" <?php if( $value == 'column' ): echo 'selected="selected"'; endif; ?>><?php esc_attr_e('Image in Column', 'folie') ?></option>
                                                                </select>
                                                                <?php echo esc_attr( $title ); ?>
                                                        </label>
                                ...
                                <fieldset class="field-move hide-if-no-js description description-wide">
                                        <span class="field-move-visual-label" aria-hidden="true"><?php esc_html_e( 'Move', 'folie' ); ?></span>
                                        <button type="button" class="button-link menus-move menus-move-up" data-dir="up"><?php esc_html_e( 'Up one', 'folie' ); ?></button>
                                        <button type="button" class="button-link menus-move menus-move-down" data-dir="down"><?php esc_html_e( 'Down one', 'folie' ); ?></button>
                                        <button type="button" class="button-link menus-move menus-move-left" data-dir="left"></button>
                                        <button type="button" class="button-link menus-move menus-move-right" data-dir="right"></button>
                                        <button type="button" class="button-link menus-move menus-move-top" data-dir="top"><?php esc_html_e( 'To the top', 'folie' ); ?></button>
                                </fieldset>

                                <div class="menu-item-actions description-wide submitbox">
                                        <?php if ( 'custom' != $item->type && $original_title !== false ) : ?>
                                                <p class="link-to-original">
                                                        <?php printf( __('Original: %s', 'folie'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                                                </p>
                                        <?php endif; ?>
                                        ...
                                        ); ?>"><?php esc_html_e( 'Remove', 'folie' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo esc_attr( $item_id ); ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
