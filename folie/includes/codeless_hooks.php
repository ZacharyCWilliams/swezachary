...
// Content -> Begin
add_action( 'codeless_hook_content_begin', 'codeless_add_page_header', 0 );
...
add_action( 'codeless_hook_content_begin', 'codeless_blog_filterable', 30 );

// Content Column -> Begin
add_action( 'codeless_hook_content_column_begin', 'codeless_add_default_page_title' );
...
add_action( 'codeless_hook_wrapper_after', 'codeless_menu_offcanvas_overlay' );
