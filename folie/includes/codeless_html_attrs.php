...
function codeless_extra_classes_content( $classes ) {
    ...
    if( is_single() )
        $classes[] = 'single_blog_align-' . codeless_get_mod( 'single_blog_align', 'left' );
...
function codeless_extra_classes_inner_content( $classes ) {
    ...
    if( codeless_get_meta( 'page_fullwidth_content', 'off', get_the_ID() ) == 'on' || codeless_get_meta( 'page_fullwidth_content', 'off', get_the_ID() ) === 1 )
...
function codeless_extra_classes_entry( $classes ) {
    ...
    if( codeless_get_mod( 'blog_boxed', false ) )
